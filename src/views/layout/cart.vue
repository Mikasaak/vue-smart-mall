  ...
  <div class="cart">
    ...
    <div class="cart-box" v-if="cartList.length > 0">
      ...
      <div class="cart-title">
        <span class="all">共<i>{{allGoodsCount || 0}}</i>件商品</span>
        <span class="edit" v-if="!isEdit" @click="isEdit=true">
        <van-icon name="edit" />
        编辑
      </span>
        <span class="cancel" v-else @click="isEdit=false">
      ...
      <div class="cart-list">
        <div class="cart-item" v-for="item in cartList" :key="item.goods_id">
          ...
          <div class="info">
            ...
            <count-box v-if="!isEdit" :value="item.goods_num" @input="setProductCount(item.goods_id,$event,item.goods_sku_id)"></count-box>
          </span>
          </div>
        </div>
      </div>
      ...
      <div class="footer-fixed">
        <div  class="all-check">
          <van-checkbox  icon-size="18" :value="isAllChecked" @click="toggleAllChecked(!isAllChecked)"></van-checkbox>
          全选
        </div>
...
export default {
  ...
  methods: {
    delCartItems () {
      ...
      this.$store.dispatch('cart/delCartItemsAction')
    },
    toggleChecked (id) {
